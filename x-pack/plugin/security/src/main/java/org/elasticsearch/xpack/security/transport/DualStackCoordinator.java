...
public class DualStackCoordinator {
    ...
    public DualStackCoordinator(ClusterSettings clusterSettings) {
        setDualStack(clusterSettings.get(XPackSettings.DUAL_STACK_HTTP_ENABLED));
        clusterSettings.addSettingsUpdateConsumer(XPackSettings.DUAL_STACK_HTTP_ENABLED, this::setDualStack);
    }
