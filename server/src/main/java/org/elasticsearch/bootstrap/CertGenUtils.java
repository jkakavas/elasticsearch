...
public class CertGenUtils {
    ...
    public static X509Certificate generateSignedCertificate(
        X500Principal principal, GeneralNames subjectAltNames, KeyPair keyPair, X509Certificate caCert, PrivateKey caPrivKey, int days)
        throws OperatorCreationException, CertificateException, CertIOException, NoSuchAlgorithmException {
    ...
    public static X509Certificate generateSignedCertificate(
        ...
        int days,
        String signatureAlgorithm) throws OperatorCreationException, CertificateException, CertIOException, NoSuchAlgorithmException {
    ...
    public static X509Certificate generateSignedCertificate(
        ...
        boolean isCa,
        int days,
        String signatureAlgorithm) throws NoSuchAlgorithmException, CertificateException, CertIOException, OperatorCreationException {
        ...
        return generateSignedCertificate(principal,
            subjectAltNames,
            keyPair,
            caCert,
            caPrivKey,
    ...
    public static X509Certificate generateSignedCertificate(
        ...
        String signatureAlgorithm) throws NoSuchAlgorithmException, CertIOException, OperatorCreationException, CertificateException {
        ...
        ContentSigner
            signer =
            new JcaContentSignerBuilder((Strings.isNullOrEmpty(signatureAlgorithm)) ?
                getDefaultSignatureAlgorithm(signingKey) :
    ...
    @SuppressForbidden(reason = "need to use getHostName to resolve DNS name and getHostAddress to ensure we resolved the name") private static void addSubjectAlternativeNames(
        boolean resolveName, InetAddress inetAddress, Set<GeneralName> list) {
